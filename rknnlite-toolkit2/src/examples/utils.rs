...
fn get_type_string(t: rknn_tensor_type) -> &'static str {
    match t {
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_FLOAT32 => "FP32",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_FLOAT16 => "FP16",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_INT8 => "INT8",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_UINT8 => "UINT8",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_INT16 => "INT16",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_UINT16 => "UINT16",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_INT32 => "INT32",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_UINT32 => "UINT32",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_INT64 => "INT64",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_BOOL => "BOOL",
        rknpu2_sys::_rknn_tensor_type_RKNN_TENSOR_INT4 => "INT4",
        _ => "UNKNOW",
    }
}
...
fn get_qnt_type_string(t: rknn_tensor_qnt_type) -> &'static str {
    match t {
        rknpu2_sys::_rknn_tensor_qnt_type_RKNN_TENSOR_QNT_NONE => "NONE",
        rknpu2_sys::_rknn_tensor_qnt_type_RKNN_TENSOR_QNT_DFP => "DFP",
        rknpu2_sys::_rknn_tensor_qnt_type_RKNN_TENSOR_QNT_AFFINE_ASYMMETRIC => "AFFINE",
        _ => "UNKNOW",
    }
}
...
fn get_format_string(fmt: rknn_tensor_format) -> &'static str {
    match fmt {
        rknpu2_sys::_rknn_tensor_format_RKNN_TENSOR_NCHW => "NCHW",
        rknpu2_sys::_rknn_tensor_format_RKNN_TENSOR_NHWC => "NHWC",
        rknpu2_sys::_rknn_tensor_format_RKNN_TENSOR_NC1HWC2 => "NC1HWC2",
        rknpu2_sys::_rknn_tensor_format_RKNN_TENSOR_UNDEFINED => "UNDEFINED",
        _ => "UNKNOW",
    }
}
